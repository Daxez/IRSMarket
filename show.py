"""
Tool to plot distributions based on aggregate id.
"""
...
def show_mulitple(aggregate_ids, no_legend=False):
    fig = pplot.figure()
    ax = fig.add_subplot(111)
...
if __name__ == '__main__':
    ...
    if(len(sys.argv) == 2):
        ...
        no_legend = False
        if(sys.argv[1] == '-no-legend'):
            no_legend = True
            aggregate_ids = sys.argv[2:]
        show_mulitple(aggregate_ids, no_legend)
