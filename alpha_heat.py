"""
    File for generating a heatmap graph on the values of alpha
    ...
    if(autocontinue or a != 'n'):
        for ten in tenure:
            for b in no_banks:
                ...
                ax.set_title(
                    "Heatmap for %d banks, term to maturity %d" % (b, ten))
...
if __name__ == '__main__':
    ...
    show_irs_vs_tenure(irs_threshold, tenure, no_banks,
                       threshold, autocontinue)
#    show_irs_vs_threshold(irs_threshold, tenure,
#                          no_banks, threshold, autocontinue)
